...
<body>
  <div class="wrap">
    <div class="header_top">
      <div class="logo">
        <a href="index.php"><img style="padding-left:2rem;" src="./images/logo1.png" alt=""></a>
...
if ($login == false) {
    ...
    <button  style="background-color:green; border-radius:1rem;font-size:1.7rem; width:100%;"> <a href="login.php">Login</a></button>
<?php
} else {
        ?>
 <button  style="background-color:red; border-radius:1rem;font-size:1.7rem; width:100%;"><a  href="?cid=<?php Session::get('cmrId'); ?>">Logout</a></button>
<?php
    }
 ?>
